...
# This function returns two arrays. First is an array of the lengths of stretches. Second is an array of whether the stretch was for 0 or 1. For example, if input is
...
for j in range(0,nFrames):
	...
	f.write(str(j)+"\t"+str(len(t))+"\t"+str(sum(data[j]))+"\t"+str(longestStretch)+"\n")
